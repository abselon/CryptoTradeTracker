          ...
          <View key={weekIndex} style={styles.calendarWeek}>
            {week.map((dayData, dayIndex) => (
              <TouchableOpacity
                ...
                style={[
                  styles.calendarDay,
                  dayData && dayData.pnl > 0 && styles.calendarDayProfit,
                  dayData && dayData.pnl < 0 && styles.calendarDayLoss,
                  dayData && (dayData.trades > 0 || dayData.sells > 0) && styles.calendarDayActive
                ]}
              ...
              >
                <Text style={[
                  ...
                  dayData && dayData.pnl !== 0 && styles.calendarDayTextActive
                ]}>
                  {dayData?.day || ''}
                </Text>
                {dayData && dayData.pnl !== 0 && (
                  <Text style={styles.calendarDayPnl}>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity style={styles.addCoinButton} onPress={handleAddCoinPress}>
          <Text style={styles.createButtonText}>Add Custom Coin</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.createButtonText}>Manage Coins</Text>
        </TouchableOpacity>
      </View>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.calendarSubtitle}>
              Green = Profit, Red = Loss, Blue = Activity
            </Text>
